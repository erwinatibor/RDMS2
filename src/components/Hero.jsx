    ...
    <section id="hero" className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-forest-950">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-14 pt-32 pb-20 w-full grid lg:grid-cols-[1.2fr_1fr] gap-12 lg:gap-16 items-center">
        ...
        <div>
          ...
          <motion.p custom={3} initial="hidden" animate="visible" variants={textVariants} className="text-lg text-white/70 font-light leading-relaxed max-w-2xl mb-12">
            A non-profit organization uniting dental surgeons, therapists, and public health professionals to advance oral and systemic health in Rwanda. We serve patients, students, healthcare professionals, and underserved communities through dental outreach, public health campaigns, research, and professional education — because oral health is not separate from general health.
          </motion.p>
